...
- Create Angular project with ng: `ng new poolleaderboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`poolleaderboard.client.esproj`).
